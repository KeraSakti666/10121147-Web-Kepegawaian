...
<body>
    ...
    <div class="w3-container">
        <h1 class="w3-center">Register Akun</h1>
        <br>
        <form action="{{route('actionregister')}}" method="post" class="w3-container w3-card-4 w3-light-grey w3-text-blue w3-margin">
            @csrf
            ...
            <hr>
            <p class="w3-center">Sudah punya akun silahkan <a href="{{route('login')}}">Login Disini!</p>
        </form>
    </div>
</body>
</html>
